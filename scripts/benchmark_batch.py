"""Script de benchmark para comparar performance entre 1-a-1 e processamento em lote."""
...
def run_benchmark():
    """Executa um benchmark de performance com diferentes tamanhos de dataset."""
    ...
    for size in [1000, 5000, 10000]:
        ...
        # Variável não utilizada removida para satisfazer F841
        comp.compare_batch(query, dataset, top_n=50, min_cosine=0.1)
