...
def test_compare_batch_short_circuit(smart_comp):
    ...
    top_hit = results[0]
    # O candidato que contém exatamente a entidade "s22 ultra" extraída ganha preferência
...
def test_compare_batch_min_cosine_filter(smart_comp):
    ...
    # Com um min_cosine de 0.2, os candidatos totalmente irrelavantes devem ser filtrados
